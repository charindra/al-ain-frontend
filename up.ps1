...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.alain-site-core-nextjs.localhost/ --auth https://id.alain-site-core-nextjs.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.alain-site-core-nextjs.localhost/ --auth https://id.alain-site-core-nextjs.localhost/ --allow-write true
}
...
Start-Process https://cm.alain-site-core-nextjs.localhost/sitecore/
Start-Process https://www.alain-site-core-nextjs.localhost/
