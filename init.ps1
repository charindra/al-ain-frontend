...
try {
    ...
    & $mkcert -install
    & $mkcert "*.alain-site-core-nextjs.localhost"
...
Add-HostsEntry "cm.alain-site-core-nextjs.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.alain-site-core-nextjs.localhost"
}
Add-HostsEntry "id.alain-site-core-nextjs.localhost"
Add-HostsEntry "www.alain-site-core-nextjs.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.alain-site-core-nextjs.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.alain-site-core-nextjs.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.alain-site-core-nextjs.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.alain-site-core-nextjs.localhost"
