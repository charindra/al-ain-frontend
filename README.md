...
1. Before you can run the solution, you will need to prepare the following
   ...
   * A valid/trusted wildcard certificate for `*.alain-site-core-nextjs.localhost`
   * Hosts file entries for `alain-site-core-nextjs.localhost`
