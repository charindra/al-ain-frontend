...
* `alain-site-core-nextjs.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `alain-site-core-nextjs-Content.module.json` contains content items which are
