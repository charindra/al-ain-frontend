...
import { READY_TO_EXPLORE_DEFAULT } from './ReadyExploreBanner.constants';
import { ReadyExploreBannerProps } from './ReadyExploreBanner.types';

const ReadyExploreBanner = ({
  fields = READY_TO_EXPLORE_DEFAULT,
}: ReadyExploreBannerProps): JSX.Element => {
  return (
      ...
      <div className="w-full mb-0 md:mb-5">
        <div className="w-full lg:w-[83.1%] md:px-6 lg:px-0 mx-auto">
          <div
            ...
            style={{ backgroundImage: `url(${fields.bannerImage})` }}
          >
